...
export function PatientProfileEnhanced({
  patient,
  onEdit,
}: PatientProfileProps) {
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
            <div className="flex items-center gap-2">
              ...
              <div className="min-w-0">
                ...
                <p className="font-medium truncate">{calculateAge(patient.birthdate)} {tPatient('years')}</p>
              </div>
            </div>
            {patient.phone_number && (
              <div className="flex items-center gap-2">
                ...
                <div className="min-w-0">
                  ...
                  <p className="font-medium truncate">{patient.phone_number}</p>
                </div>
              </div>
            )}
            {patient.email && (
