  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const topClinics: ClinicDisplay[] = allClinics
          .slice(0, 5)
          .map((clinic, index) => ({
            ...clinic,
        ...
        const topDoctors: DoctorDisplay[] = allDoctors
          .slice(0, 5)
          .map((doctor, index) => ({
            ...doctor,
    ...
    const ctx = gsap.context(() => {
      ...
      if (partnersRef.current) {
        const partnersContainer =
          partnersRef.current.querySelector('.partners-track');
              ...
              {clinics.map((clinic) => {
                ...
                return (
                  ...
                  >
                    <CardHeader>
                      <div
                        className={`w-14 h-14 ${clinic.color} rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                      >
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-7xl mx-auto">
              {doctors.map((doctor) => (
                <Card
                  key={doctor.id}
                  className="doctor-card overflow-hidden hover:shadow-xl transition-shadow duration-300"
                >
        ...
        <section className="py-20 bg-gradient-to-r from-emerald-600 to-blue-600 dark:from-emerald-800 dark:to-blue-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link href={`/${locale}/register`}>
              <Button
                size="lg"
                className="bg-white text-emerald-600 hover:bg-emerald-50 px-8 py-6 text-lg group"
              >
                {t('cta.button')}
                <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
